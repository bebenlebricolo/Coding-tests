...
toto_test_error_codes_t toto_test_config_init(toto_test_config_t* const config)
{
  if (NULL == config)
  {
    return TOTO_TEST_ERROR_NULL_POINTER;
...
toto_test_error_codes_t toto_test_config_allocate(const size_t name_length, const size_t version_length, toto_test_config_t* const config)
{
  if (NULL == config)
  {
    return TOTO_TEST_ERROR_NULL_POINTER;
...
static toto_test_error_codes_t  config_set_string(char const * const msg, const size_t size, string_t * const str)
{
...
toto_test_error_codes_t toto_test_config_set_name(char const* const name, const size_t size, toto_test_config_t* const config)
{
  if (NULL == config)
  {
    return TOTO_TEST_ERROR_NULL_POINTER;
...
toto_test_error_codes_t toto_test_config_set_version(char const* const version, const size_t size, toto_test_config_t* const config)
{
  if (NULL == config)
  {
    return TOTO_TEST_ERROR_NULL_POINTER;
...
toto_test_error_codes_t toto_test_config_destroy(toto_test_config_t* const config)
{
  if (NULL == config)
  {
    return TOTO_TEST_ERROR_NULL_POINTER;
