...
def print_help():
    print("\n=========================================================================")
    print("XYZ python component inverter for XYZ ASCII file format")
    print("=========================================================================\n")
    ...
    print("  Usage : python3 xyz_component_inverter.py <File> <Components> [OPTS : <outputfile>]")
    ...
    print("Example : ")
    print("    + python3 xyz_component_inverter.py Horizon.xyz X")
    print("    + python3 xyz_component_inverter.py C:\\temp\\data\\Horizon.xyz XY\n")
...
def invert_component(comp_to_invert : str, line : str) -> str :
    ...
    if comp_to_invert.capitalize().find('X') != -1:
        components[0] = invert_single_str(components[0])
    ...
    inverted_line = "{} {} {}".format(components[0], components[1], components[2])
...
def main(argv) -> int :
    ...
    try:
        if input.outfile :
            ...
            input.outfile = Path.joinpath(input_dir, filename + "_inv.xyz")
            output_file = open(input.outfile, "w")
    except OSError as e:
